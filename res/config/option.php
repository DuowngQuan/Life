...
class ThanhDieuHeader implements ThanhDieuConfigInterface {
    public $title = "Dương Đại Hồng Quân | Resource v5";
    public $description = "Hi my name is Hong Quan / A freelancer / web developer / vexer";
    public $keywords = "hongquan,web hong quan,duong dai hong quan,hongquan home,profile hongquan";
    public $favicon = "./res/v5/img/logo.jpg";
    public $namesite = "Hồng Quân | HomePage";
    public $avatar = "./res/v5/img/avatar.gif";
    public $userName = ["Hello Everybody", "My name is HongQuan.", "I really like website design 🌭"];
    public $trigger = "👉 Tìm hiểu tôi 😶&zwj;🌫️";
    public $bio1 = "🤖️ Người đâm mê IT";
    public $bio2 = "🔍 Chia sẻ và giúp đỡ nhiệt tình";
    public $bio3 = "💻 Kỹ sư phát triển front-end";
    public $bio4 = "Thích làm thần tượng Facebook 🥳";
    public $bio5 = "Ăn, ngủ, làm và chơi game 🎮";
    public $bio6 = "Kẻ khờ dại tin vào tình yêu ✨";
    public $SocialNetworks = [
        "facebook" => "https://www.facebook.com/profile.php?id=100004025965383", // Thay link facebook
        "instagram" => "https://www.instagram.com/24th.ofdecber", // Thay link instagram
        "tiktok" => "https://www.tiktok.com/", // Thay link tiktok
        "telegram" => "https://t.me/ItsPokiZino" // Thay link telegram
    ];
...
class ThanhDieuLoveDays implements ThanhDieuConfigInterface {
    public $ConfigLove = [
        ...
        "name_male" => "Hong Quan", // Thay tên của bạn
        //========================================================//
        ...
        "name_female" => "Min Chou ", // Thay tên đối phương
        //========================================================//
        "time_relashiption" => "20/10/2024" // Định dạng ngày tháng năm: DD-MM-YYYY or / or :
        //========================================================//
    ];
    public function CommonMethod() {}
}
